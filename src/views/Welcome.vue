<template>
<div class="p-5 w-full h-screen bg-[url('https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80')]">
    <div class="bg-zinc-900 w-[800px] mx-auto border rounded-lg text-center text-white opacity-95 p-4">
        ...
        <div class="m-2 px-6 py-4">
            ...
            <router-link to="/login">
                <button
                class="ml-5 text-[1.2rem] font-bold bg-zinc-900 py-2 px-4 border border-zinc-500 rounded-lg hover:bg-zinc-700 hover:text-white ">Login
                </button>
            </router-link>
        </div>
    </div>
